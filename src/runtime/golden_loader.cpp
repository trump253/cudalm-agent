...
Status GoldenFile::validate_golden_tensors() const {
  ...
  // Q-path stages (q/rope_q/attention_output) are q_proj_out wide; KV-path
  // stages (k/rope_k) are kv_proj_out wide — independent of hidden_size.
